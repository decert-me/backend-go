...
type UserChallenges struct {
	...
	Address  string         `gorm:"column:address;type:char(42);index:challenges_address_questId,UNIQUE;comment:钱包地址" json:"address" form:"address"`
	QuestID  uint           `gorm:"column:quest_id;index:challenges_address_questId,UNIQUE;"`
