...
type Collection struct {
	...
	EstimateTime     uint8          `gorm:"column:estimate_time;comment:预估时间/min" json:"-"`                            // 预估时间/min
	...
	CollectionStatus uint8          `gorm:"column:collection_status;default:0;comment:合辑状态 1 独立 2 合辑" json:"-"`
}
