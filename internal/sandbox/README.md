...
[![Go Reference](https://pkg.go.dev/badge/backend-go/sandbox.svg)](https://pkg.go.dev/backend-go/sandbox) [![Go Report Card](https://goreportcard.com/badge/backend-go/sandbox)](https://goreportcard.com/report/backend-go/sandbox) [![Release](https://img.shields.io/github/v/tag/criyle/go-judge)](https://backend-go/sandbox/releases/latest) ![Build](https://backend-go/sandbox/workflows/Build/badge.svg)
...
Download compiled executable from [Release](https://backend-go/sandbox/releases) and run.
