...
func bindBadgeMinter(address common.Address, caller bind.ContractCaller, transactor bind.ContractTransactor, filterer bind.ContractFilterer) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(BadgeMinterABI))
	if err != nil {
		return nil, err
	}
...
func (_BadgeMinter *BadgeMinterTransactor) UpdateQuest(opts *bind.TransactOpts, questId *big.Int, startTs uint32, endTs uint32, title string, questUri string, signature []byte) (*types.Transaction, error) {
	return _BadgeMinter.contract.Transact(opts, "updateQuest", questId, startTs, endTs, title, questUri, signature)
}

// UpdateQuest is a paid mutator transaction binding the contract method 0xce869d70.
//
// Solidity: function updateQuest(uint256 questId, uint32 startTs, uint32 endTs, string title, string questUri, bytes signature) returns()
func (_BadgeMinter *BadgeMinterSession) UpdateQuest(questId *big.Int, startTs uint32, endTs uint32, title string, questUri string, signature []byte) (*types.Transaction, error) {
...
//
// Solidity: function updateQuest(uint256 questId, uint32 startTs, uint32 endTs, string title, string questUri, bytes signature) returns()
func (_BadgeMinter *BadgeMinterTransactorSession) UpdateQuest(questId *big.Int, startTs uint32, endTs uint32, title string, questUri string, signature []byte) (*types.Transaction, error) {
	return _BadgeMinter.Contract.UpdateQuest(&_BadgeMinter.TransactOpts, questId, startTs, endTs, title, questUri, signature)
}
