...
// InitQuest is a paid mutator transaction binding the contract method 0xab2671d4.
//
// Solidity: function initQuest(uint256 questId, (address,uint32,uint32,string,string) questData) returns()
func (_BadgeV2 *BadgeV2Transactor) InitQuest(opts *bind.TransactOpts, questId *big.Int, questData IBadgeQuestData) (*types.Transaction, error) {
	return _BadgeV2.contract.Transact(opts, "initQuest", questId, questData)
}

// InitQuest is a paid mutator transaction binding the contract method 0xab2671d4.
//
// Solidity: function initQuest(uint256 questId, (address,uint32,uint32,string,string) questData) returns()
func (_BadgeV2 *BadgeV2Session) InitQuest(questId *big.Int, questData IBadgeQuestData) (*types.Transaction, error) {
	return _BadgeV2.Contract.InitQuest(&_BadgeV2.TransactOpts, questId, questData)
}

// InitQuest is a paid mutator transaction binding the contract method 0xab2671d4.
//
// Solidity: function initQuest(uint256 questId, (address,uint32,uint32,string,string) questData) returns()
func (_BadgeV2 *BadgeV2TransactorSession) InitQuest(questId *big.Int, questData IBadgeQuestData) (*types.Transaction, error) {
	return _BadgeV2.Contract.InitQuest(&_BadgeV2.TransactOpts, questId, questData)
}
