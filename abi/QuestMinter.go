...
func (_QuestMinter *QuestMinterTransactor) UpdateBadgeNum(opts *bind.TransactOpts, questId *big.Int, badgeNum *big.Int, signature []byte) (*types.Transaction, error) {
	return _QuestMinter.contract.Transact(opts, "updateBadgeNum", questId, badgeNum, signature)
}

// UpdateBadgeNum is a paid mutator transaction binding the contract method 0x1f043e22.
//
// Solidity: function updateBadgeNum(uint256 questId, uint256 badgeNum, bytes signature) returns()
func (_QuestMinter *QuestMinterSession) UpdateBadgeNum(questId *big.Int, badgeNum *big.Int, signature []byte) (*types.Transaction, error) {
	return _QuestMinter.Contract.UpdateBadgeNum(&_QuestMinter.TransactOpts, questId, badgeNum, signature)
}

// UpdateBadgeNum is a paid mutator transaction binding the contract method 0x1f043e22.
//
// Solidity: function updateBadgeNum(uint256 questId, uint256 badgeNum, bytes signature) returns()
func (_QuestMinter *QuestMinterTransactorSession) UpdateBadgeNum(questId *big.Int, badgeNum *big.Int, signature []byte) (*types.Transaction, error) {
	return _QuestMinter.Contract.UpdateBadgeNum(&_QuestMinter.TransactOpts, questId, badgeNum, signature)
}
